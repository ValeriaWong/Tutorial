...
在本节中，将一步步带领大家体验如何使用 XTuner 进行InternVL的微调！

> 本部分需要的GPU资源为40GB 50% 的 A100。
...
<tbody>
<tr>
<td>输入</td><td>请从这张聊天截图中提取结构化信息</td><td>请从这张聊天截图中提取结构化信息</td>
</tr>
<tr>
...
本节主要重点是带领大家实现使用xtuner进行internvl的微调，如果想了解微调相关的基本概念，可以访问[XTuner微调前置基础](./xtuner_finetune_basic.md)；如果想了解internvl相关的知识，可以访问[llava简介]()。
...
> 对于学习而言，我们可以使用 InternVL-2B的小模型来完成此次微调演示。
